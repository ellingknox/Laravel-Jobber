...
<div class="wrapper wrapper-content calendar-week">
...
<div class="modal inmodal" id="event-modal" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                ...
                <h4 class="modal-title headingTwo text-left">Edit event</h4>
            </div>
            <div class="modal-body">
                ...
                <div class="row event-edit-main">
                    <div class="col-lg-12 event-edit-details-parent">
                        <div class="event-edit-details">
                            <input type="text" class="form-control" name="title" required placeholder="title"></input>
                            
                            <textarea rows="4" class="form-control" name="note" placeholder="description"></textarea>
                        </div>
                        <div class="row event-edit-scheduling-assign ">
                            <div class="col-lg-12 event-edit-scheduling-parent">
                                <div class="event-edit-scheduling">
                                    <div class="row">
                                        ...
                                        <div class="input-daterange">
                                            ...
                                            <input type="text" class="form-control start-date" value="2018-1-28" id="event-modal-start-id" name="start_date"></input>
                                            <label>End date</label>
                                            <input type="text" class="form-control end-date" value="2018-1-30" id="event-modal-end-id" name="end_date"></input>
                                        </div>
                                        ...
                                        <div class="col-lg-6 event-edit-scheduling-time">
                                            ...
                                            <input type="text" class="form-control start-time" value="00:00" data-mask="99:99" name="start_time"></input>
                                            <label>End time</label>
                                            <input type="text" class="form-control end-time" value="00:00" data-mask="99:99" name="end_time"></input>
                                        </div>
                                ...
                                <input type="text" class="hide" name="event-distinct" id="week-event-distinct-input"></input>
                                 <input type="text" class="hide" value="week" name="route"></input>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <input type="text" style="display: none;" name="id" class="hidden_input_id"></input>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal inmodal" id="event-job-editmodal" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content animated bounceInRight">
            ...
            <form method ='post' action="{{ route('Calendar.edit') }}">
                {{ csrf_field() }}
                <input type="hidden" name="route" value="week">
                <div class="row event-edit-main">
    ...
    <div class="modal inmodal" id="job-detailmodal" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content animated bounceInRight">
            ...
            <div class="row nopadding visit-detail-btn">
                        ...
                        <div class="col-lg-6">
                            <a class="btn custom-font-border event-detailmodal-btn deatilmodal_btn width-100 hide-limited-worker hide-worker" onClick="action_detect()">Actions</a>
                        </div>
                    </div>
                            ...
                            <div class="tab-content">
                                <div id="tab-1" class="tab-pane row nopadding active">
                                    <div class="col-lg-12 border-bottom nopadding">
                                        <h4 class="custom-font-color">Details</h4>
                                        <p class="details">adfasf</p>
                                    </div>
                                    <div class="col-lg-12 nopadding border-bottom display-flex">
                                        ...
                                        <div class="col-lg-4 border-right">
                                            ...
                                            <!-- <p class="jobber-icon jobber-allowright team"></p> -->
                                        </div>
                                        <div class="col-lg-4">
                                            <h4 class="custom-font-color">Reminders</h4>
                                            <!-- <p class="jobber-icon jobber-allowright reminder"></p> -->
                                        </div>
                                    </div>
            ...
            <div class="modal-body">
                <ul class="unstyled nopadding">
                    <li class="border-bottom">
                        <span>1.</span>
                        <a href="" >Close the job</a>
                    </li>
                    <li class="border-bottom">
                        <span>2.</span>
                        <a href="">Schedule Next Visit</a>
                    </li>
                    <li class="border-bottom">
                        <span>3.</span>
                        <a href="">Leave Status as "Action required"</a>
                    </li>
                </ul>
            </div>
        </div>
          ...
          allDayDefault: false,
           ...
           drop: function() {
            ...
            eventClick: function (calEvent, jsEvent, view) {
                ...
                html: true,
                content: function() {
                    return '<ul class="event-popover-content unstyled">    <li><h4>Team</h4><p>John Marker</p>     </li><li><div class="event-popover-time click-start"><h4>Start</h4><p>24/01/2018 05:30</p></div><div class="event-popover-time click-end"><h4>Ends</h4><p>24/01/2018 08:30</p></div>     </li><li><div class="event-popover-link"><a data-toggle="modal" data-target="#event-modal" class="btn btn-success pull-left btn-xs" onClick="edit_event()" >Edit</a></div><div class="event-popover-link"><a data-toggle="modal" data-target="#event-detailmodal" class="btn btn-default btn-xs pull-right" onClick="closePopovers()">View Detail</a></div></li></ul>';
                }
              });
