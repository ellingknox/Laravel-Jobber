                                ...
                                <div class="col-md-12" id="lineItem">
                                    <div class="ibox">
                                        <div class="ibox-content table-content">
                                            <input type="hidden" name="invoice[job]" value=""></input>
                                            <table class="table lineitemTable text-right">
                                                ...
                                                <tbody id="lineItemBox">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="hidden" class="action-border  form-control service_id" name="invoice[lineitem][0][service_id]" value="" required="" />
                                                            <input type="text" class="form-control grey-title" name="invoice[lineitem][0][name]" id="servicelist_0" required="" onchange="selectService(this)" style="width: 100%;">
                                                        ...
                                                        <td>
                                                            <input type="text" class="action-border  form-control text-right unitcostval" name="invoice[lineitem][0][unitcost]"  value="0.00" required="" onchange="setcost(this);" />
                                                        </td>
                                                        <td>
                                                            <input type="text" class="action-border  form-control text-right total"value="0.0"/>
                                                            <button type="button" class="btn btn-white btn-xs del-product-btn" onclick="deleterow(this)">Delete</button>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                        ...
                        <div class="col-md-12 text-right">
                            ...
                            <div class="control-group">
                                ...
                                <div class="btn-group dropup">
                                    <button class="btn action-btn saveinvoice" type="button"><strong>Save Invoice</strong></button>
